    ...
    validateInputs: () => {
      return new Promise(async resolve => {
        ...
        try {
          ...
          const lsfRequireAuth = 0x00020000; 
          ...
          if ((flags & lsfRequireAuth) && !trustline.peer_authorized) {
            log("Failed to Mint Tokens: Trustline not authorized.");
            errorElement.textContent = 'Trustline not authorized.';
            resolve(false);
            return;
          }
